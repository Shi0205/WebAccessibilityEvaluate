      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12">
          <div class="page-header text-center"><br>
            <h2>Adjusted Rule's User</h2>
          </div>
          <br>

          <div class="result_analysis mb-5 card cards ">
            <div class="m-2 row">
              <p><b>Total User : </b> <?php echo $adjusted_rule_user; ?></p>
              <hr>

              <div class="sm-6 col">
                <p><b>Mean Accessibility Rank :</b> <?php echo number_format(array_sum($a_accessibility)/ $adjusted_rule_user,2); ?></p>
                ...
                if($adjusted_rule_user %2 == 0){
                  $median = ($a_accessibility[$a_middle] + $a_accessibility[$a_middle+1]) /2;
                } else{
        ...
        <table id="adjusted_rule_tbl" class="table table-striped table-bordered" style="width:100%" >
         <thead >
          <tr>
            <th>User Id</th>
      ...
      // Read
          ...
          foreach($result as $readrow) {
            ...
            <tr>
             ...
             <td><a href="adjusted_user_details.php?uid=<?php echo $readrow['fld_user_id']; ?>"class="btn btn-warning btn-xs" role="button" >Details</a></td>
           </tr>
           <?php
         }
         $conn = null;
