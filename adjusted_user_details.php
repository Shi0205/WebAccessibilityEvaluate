...
<head>
 ...
 <style type="text/css">
  ...
  .table_per th, .table_per td, .table_ope th, .table_ope td , .table_und th, .table_und td, .table_rob th, .table_rob td{
    border: 1px solid black;
    padding: 8px;
    text-align: center;
  }

  .table_per th , .table_ope th, .table_und th, .table_rob th{
...
<body  class="sb-nav-fixed mb-5">
  ...
  <div class="main-content">
    ...
    try {
     ...
     $stmt = $conn->prepare("SELECT * FROM fyp_tbl_user, fyp_tbl_perceivable, fyp_tbl_operable, fyp_tbl_understandable, fyp_tbl_robust, fyp_tbl_per_rule, fyp_tbl_ope_rule, fyp_tbl_und_rule, fyp_tbl_rob_rule WHERE fyp_tbl_user.fld_user_id = fyp_tbl_perceivable.fld_user_id AND fyp_tbl_user.fld_user_id = fyp_tbl_operable.fld_user_id AND fyp_tbl_user.fld_user_id = fyp_tbl_understandable.fld_user_id  AND fyp_tbl_user.fld_user_id = fyp_tbl_robust.fld_user_id AND fyp_tbl_user.fld_user_id = fyp_tbl_per_rule.fld_user_id AND fyp_tbl_user.fld_user_id = fyp_tbl_ope_rule.fld_user_id AND fyp_tbl_user.fld_user_id = fyp_tbl_und_rule.fld_user_id AND fyp_tbl_user.fld_user_id = fyp_tbl_rob_rule.fld_user_id  AND fyp_tbl_user.fld_user_id = :uid");
   ...
   $conn = null; 
   ?>
   <p class="link_to_main"><a href="admin_adjusted.php">Adjusted Rule's User</a> / <?php echo $uid; ?></p>
   <div class="container-fluid">
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-12">
        <div class="page-header text-center"><br>
          <h2 class="mb-4">Adjusted Rule's User</h2>
    ...
    <div class="container mb-2">
      <div class="table_per"> 
        <div class="row"> 
          ...
          <tbody>
            <tr>
              <td>Rank ≤ <?php echo $readrow['fld_per_rankVeryHigh']; ?></td>
              <td>Very High</td>
              <td>The e-commerce website fulfills most of the perceivable success criteria.</td>
              <td>Criteria ≥ <?php echo $readrow['fld_per_criteriaVeryHigh']; ?></td>
            </tr>
            <tr>
              <td>Rank ≤ <?php echo $readrow['fld_per_rankHigh']; ?></td>
              <td>High</td>
              <td>The e-commerce website fulfills many perceivable success criteria.</td>
              <td>Criteria ≥ <?php echo $readrow['fld_per_criteriaHigh']; ?></td>
            </tr>
            <tr>
              <td>Rank ≤ <?php echo $readrow['fld_per_rankModerate']; ?></td>
              <td>Moderate</td>
              <td>The e-commerce website fulfills half of the perceivable success criteria.</td>
              <td>Criteria ≥ <?php echo $readrow['fld_per_criteriaModerate']; ?></td>
            </tr>
            <tr>
              <td>Rank ≤ <?php echo $readrow['fld_per_rankLow']; ?></td>
              <td>Low</td>
              <td>The e-commerce website fulfills some of the perceivable success criteria.</td>
              <td>Criteria ≥ <?php echo $readrow['fld_per_criteriaLow']; ?></td>
            </tr>
            <tr>
              <td>Rank ≤ <?php echo $readrow['fld_per_rankVeryLow']; ?></td>
              <td>Very Low</td>
              <td>The e-commerce website did not fulfill or fulfill very few perceivable success criteria.</td>
              <td>Criteria ≥ <?php echo $readrow['fld_per_criteriaVeryLow']; ?></td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  <div class="container mb-2">
   <div class="table_ope">
    <div class="row">
      ...
      <tbody>
        <tr>
          <td>Rank ≤ <?php echo $readrow['fld_ope_rankVeryHigh']; ?></td>
          <td>Very High</td>
          <td>The e-commerce website fulfills most of the operable success criteria.</td>
          <td>Criteria ≥ <?php echo $readrow['fld_ope_criteriaVeryHigh']; ?></td>
        </tr>
        <tr>
          <td>Rank ≤ <?php echo $readrow['fld_ope_rankHigh']; ?></td>
          <td>High</td>
          <td>The e-commerce website fulfills many operable success criteria.</td>
          <td>Criteria ≥ <?php echo $readrow['fld_ope_criteriaHigh']; ?></td>
        </tr>
        <tr>
          <td>Rank ≤ <?php echo $readrow['fld_ope_rankModerate']; ?></td>
          <td>Moderate</td>
          <td>The e-commerce website fulfills half of the operable success criteria.</td>
          <td>Criteria ≥ <?php echo $readrow['fld_ope_criteriaModerate']; ?></td>
        </tr>
        <tr>
          <td>Rank ≤ <?php echo $readrow['fld_ope_rankLow']; ?></td>
          <td>Low</td>
          <td>The e-commerce website fulfills some of the operable success criteria.</td>
          <td>Criteria ≥ <?php echo $readrow['fld_ope_criteriaLow']; ?></td>
        </tr>
        <tr>
          <td>Rank ≤ <?php echo $readrow['fld_ope_rankVeryLow']; ?></td>
          <td>Very Low</td>
          <td>The e-commerce website did not fulfill or fulfill very few operable success criteria.</td>
          <td>Criteria ≥ <?php echo $readrow['fld_ope_criteriaVeryLow']; ?></td>
        </tr>
      </tbody>
    </table>
  </div>
 ...
 <div class="table_und">
  <div class="row">
   ...
   <table class="text-center">
    ...
    <tbody>
      <tr>
        <td>Rank ≤ <?php echo $readrow['fld_und_rankHigh']; ?></td>
        <td>High</td>
        <td>The e-commerce website fulfills most of the understandable success criteria.</td>
        <td>Criteria ≥ <?php echo $readrow['fld_und_criteriaHigh']; ?></td>
      </tr>
      <tr>
        <td>Rank ≤ <?php echo $readrow['fld_und_rankModerate']; ?></td>
        <td>Moderate</td>
        <td>The e-commerce website fulfills some of the understandable success criteria.</td>
        <td>Criteria ≥ <?php echo $readrow['fld_und_criteriaModerate']; ?></td>
      </tr>
      <tr>
        <td>Rank ≤ <?php echo $readrow['fld_und_rankLow']; ?></td>
        <td>Low</td>
        <td>The e-commerce website did not fulfill or fulfill very few understandable success criteria.</td>
        <td>Criteria ≥ <?php echo $readrow['fld_und_criteriaLow']; ?></td>
      </tr>
    </tbody>
  </table>
</div>
...
<div class="container mb-2">
 <div class="table_rob">
   <div class="row">
    ...
    <tbody>
      <tr>
        <td>Rank ≤ <?php echo $readrow['fld_rob_rankHigh']; ?></td>
        <td>High</td>
        <td>The e-commerce website fulfills most of the robust success criteria.</td>
        <td>Criteria ≥ <?php echo $readrow['fld_rob_criteriaHigh']; ?></td>
      </tr>
      <tr>
        <td>Rank ≤ <?php echo $readrow['fld_rob_rankModerate']; ?></td>
        <td>Moderate</td>
        <td>The e-commerce website fulfills some of the robust success criteria.</td>
        <td>Criteria ≥ <?php echo $readrow['fld_rob_criteriaModerate']; ?></td>
      </tr>
      <tr>
        <td>Rank ≤ <?php echo $readrow['fld_rob_rankLow']; ?></td>
        <td>Low</td>
        <td>The e-commerce website did not fulfill or fulfill very few robust success criteria.</td>
        <td>Criteria ≥ <?php echo $readrow['fld_rob_criteriaLow']; ?></td>
      </tr>
    </tbody>
  </table>
</div>
